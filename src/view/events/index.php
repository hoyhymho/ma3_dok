  ...
  <div class="headercontent">
    <picture>
      <source
          ...
          srcset="assets/img/header_logo_small.png">
      <source
        srcset="assets/img/header_logo.png">
    ...
    <picture>
      <source
          media="(max-width: 740px)"
          srcset="assets/img/header_date_small.png">
      <source
        srcset="assets/img/header_date.png">
...
<section class="dokopent width">
  <article class="relative">
    <img src="assets/img/sfeerbeeld1.png" alt="" class="sfeerbeeld1">
  ...
  <article class="yellowbg">
    <div class="dok2017_content width">
      <picture>
        <source
            media="(max-width: 740px)"
            srcset="assets/img/splash_bewoners_small.png">

        <source
          srcset="assets/img/splash_bewoners.png">

        <img src="assets/img/splash_bewoners.png" alt="dokbewoners">
      </picture>
      <div>
        <h3>DOK 2017</h3>
